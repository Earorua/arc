...
**Paused at user request (2026-09-06):** Save the new read-only account evidence, support draft and initial RED from `2026-09-06-arc-v8-provider-error-observation.md`. No observer implementation or new paid request has completed. Resume from the highest-priority pause block in `docs/operations/v8-resume-checkpoint.md`; the old first-request authorization remains consumed.
