    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="editorial-section method-preview">
          <p className="section-index" lang="en">
            01 · Method
          </p>
          <h2>路线不是课程目录。它是一组有依赖、有证据、有时间预算的决定。</h2>
          <Link href="/method" lang="en">
            Explore the method →
          </Link>
        </section>
        <section className="editorial-section product-preview">
          ...
          <div>
            <strong lang="en">Today</strong>
            <span>只做今天最重要的 45 分钟。</span>
          </div>
          <div>
            <strong lang="en">Path</strong>
            <span>看清十八周如何抵达岗位目标。</span>
          </div>
          <div>
            <strong lang="en">Proof</strong>
            <span>把完成记录变成可分享的能力证据。</span>
          </div>
        </section>
        <section className="final-cta" lang="en">
          <h2>
